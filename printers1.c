...
int o_print_char(va_list types, char buffer[], int flags, int width, int precision, int size)
{
	...
	return (o_handle_write_char(c, buffer, flags, width, precision, size));
}

/************************* PRINT A STRING *************************/
/**
 * o_print_string - Prints a string
 * @types: List a of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
...
/************************* PRINT PERCENT SIGN *************************/
/**
 * o_print_percent - Prints a percent sign
...
int o_print_int(va_list types, char buffer[], int flags, int width, int precision, int size)
{
	...
	n = o_convert_size_number(n, size);
	...
	return (o_write_number(is_negative, i, buffer, flags, width, precision, size));
}

/************************* PRINT BINARY *************************/
/**
 * o_print_binary - Prints an unsigned number
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
